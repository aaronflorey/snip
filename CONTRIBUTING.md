...
See the [Filter DSL documentation](https://github.com/aaronflorey/snip/wiki) for available actions.
...
- Merge releasable changes into `master` and let the release PR carry the version bump and changelog.
- Merging the release PR publishes GitHub release archives and updates `aaronflorey/homebrew-tap`.
...
Open an [issue](https://github.com/aaronflorey/snip/issues) or check existing issues.
